...
def main() -> None:
    ...
    repo_name = os.environ["GITHUB_REPOSITORY"]  # needs full repo-name with username e.g. vroomfondel/jwtjwkhelper

    history_filename = "jwtjwkhelper_clone_history.json"
    badge_filename = "jwtjwkhelper_clone_count.json"
